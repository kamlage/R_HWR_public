...
######option1, pivoted data

##extract data from gapminder
#minimum
...
##combine single datasets for a dataset to plot
...
plot_just_4_legend_creation <- ggplot(data_plot, aes(x=year)) +
...
# extract legend 
legend <- get_legend(plot_just_4_legend_creation)   
