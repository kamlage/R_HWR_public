...
```
From Figure 1 we can see that Asia is the most populous continent. In 2007, the percentage of the population of the Asian continent represents `r round(perc_pop_continent$perc[3], digits=2)`% of the world’s population.
